...
export var createStore = function (initialState, reducers) {
    ...
    var actionStore = {
        setState: setState,
        state: initialState,
        actions: Object.entries(reducers).reduce(function (acc, _a) {
    ...
    actionStore["__internal"] = internals;
    return actionStore;
};
...
var useStore = function (store) {
    ...
    return {
        state: state,
        setState: setState,
        actions: Object.entries(internals.reducers).reduce(function (acc, _a) {
            var _b = __read(_a, 2), key = _b[0], reducer = _b[1];
            acc[key] = function (payload) { return __awaiter(_this, void 0, void 0, function () {
                var newState;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, reducer(state, payload)];
                        case 1:
                            newState = _a.sent();
                            Object.entries(internals.setters).forEach(function (_a) {
                                var _b = __read(_a, 2), k = _b[0], setter = _b[1];
