    ...
    return Object.entries(reducers).reduce(function (acc, _a) {
        ...
        acc[key] = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, reducer(copyState(stateReceiver.receiver()), payload)];
                    case 1:
                        newState = _a.sent();
...
export var createStore = function (initialState, reducers) {
    ...
    var actions = mapActions(reducers, { setState: setState, receiver: function () { return actionStore.state; } }, internals);
